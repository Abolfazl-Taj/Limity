  ...
  return (
    <div className="Join " data-aos="zoom-out-up">
        ...
        <div className="Join_Form">
                <h6 className="Join_Header">فقط یک لحظه</h6>
                <h1 className="Join_Heder">به خبرنامه ما بپیوندید!</h1>
                <p className="Join_Desc">عضو خبرنامه ما شوید و از آخرین اخبار و آخرین محصولات ما به سرعت باخبر شوید.</p>
                <div className="Join_Sign">
                    <input type="text" className="Join_Input" placeholder="آدرس ایمیل خود را وارد کنید" />
                    <button className="Join_Btn">    <i> <LiaTelegramPlane/> </i>  </button>
                </div>
        </div>
